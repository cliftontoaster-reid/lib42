...
/*   Updated: 2025/11/20 11:51:36 by lfiorell@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @defgroup ft::memory Libft-like memory manipulation functions
 * @brief A collection of functions for manipulating memory blocks.
 *
 * This namespace provides implementations of common memory operations
 * similar to those found in the C standard library, with additional
 * functionality and safety features. Functions include memory copying,
 * moving, setting, zeroing, scanning, comparing, and searching.
 */
